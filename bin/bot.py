...
async def on_member_join(member):
    guild = client.get_guild(783515548192866345) # server id for the server the bot will use
    channel = guild.get_channel(872356789822312479) # channel the bot will send the message to
    await channel.send(
